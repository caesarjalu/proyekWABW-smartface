...
const Navigation = ({onRouteChange, isSignedIn}) => {
	if( isSignedIn){
		...
		return (
			<nav className="dt w-100 border-box pa3 ph4-l" style={{position: 'sticky', top: 0}}>
			<div className="db dtc-m v-mid w-10 tc tl-l">
				<Logo />
			</div>
			<div className="dtc v-mid w-80 tc tl-l">
				<b className="link dim dark-gray f3 dib ml3 mr4-l">SMART FACE</b>
			</div>
			<div className="dtc v-mid w-10 tc tr-l">
				<p onClick={() => onRouteChange('signin')} className="link dim dark-gray f6 f5-l dib pointer">Sign In</p>
			</div>
			<div className="dtc v-mid w-10 tc tc-l">
